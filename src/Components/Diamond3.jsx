...
export function Diamond3(props) {
  const model = useRef()
  const [id, setId] = useState()
  const { nodes, materials } = useGLTF('/Model/diamond3.glb')
  ...
  return (
    ...
    <CubeCamera resolution={256} frames={1} envMap={texture}>
      {(texture) => (
        ...
        <instancedMesh ref={model} args={[nodes.DIAMOND172.geometry, null, diamonds.length]}>
...
useGLTF.preload('/Model/diamond3.glb')
