...
export function Diamond5(props) {
  const model = useRef()
  const [id, setId] = useState()
  const { nodes, materials } = useGLTF('/Model/diamond5.glb')
  ...
  return (
    ...
    <CubeCamera resolution={256} frames={1} envMap={texture}>
      {(texture) => (
        ...
        <instancedMesh ref={model} args={[nodes.DIAMOND170.geometry, null, diamonds.length]}>
...
useGLTF.preload('/Model/diamond5.glb')
