...
Command: npx gltfjsx@6.1.11 diamond5.glb
*/
// nodes.DIAMOND170.geometry
...
export function Diamond6(props) {
  const model = useRef()
  const [id, setId] = useState()
  const { nodes, materials } = useGLTF('/Model/diamond6.glb')
  ...
  return (
    ...
    <CubeCamera resolution={256} frames={1} envMap={texture}>
      {(texture) => (
        ...
        <instancedMesh ref={model} args={[nodes.DIAMOND171.geometry, null, diamonds.length]}>
...
useGLTF.preload('/Model/diamond6.glb')
