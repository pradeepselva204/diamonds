...
*/
//nodes.Diamond_Emerald_cut001.geometry
...
export function Diamond7(props) {
  const model = useRef()
  const [id,setId] = useState()
  const { nodes, materials } = useGLTF('/Model/diamond7.glb')
  ...
  return (
    ...
    <CubeCamera resolution={256} frames={1} envMap={texture}>
      {(texture) => (
        ...
        <instancedMesh ref={model} args={[nodes.Diamond_Emerald_cut001.geometry, null, diamonds.length]}>
...
useGLTF.preload('/Model/diamond7.glb')
