...
*/
//nodes.Diamond_Emerald_cut.geometr
...
export function Diamond12(props) {
  const model = useRef()
  const [id,setId] = useState()
  const { nodes, materials } = useGLTF('/Model/diamond12.glb')
  ...
  useFrame((state, delta) => {
    ...
    diamonds.forEach((data, i) => {
        ...
        dummy.rotation.set(rotation[0] , Math.PI/2, rotation[2])
  ...
  return (
    ...
    <CubeCamera resolution={256} frames={1} envMap={texture}>
      {(texture) => (
        ...
        <instancedMesh ref={model} args={[nodes.Diamond_Emerald_cut.geometry, null, diamonds.length]}>
...
useGLTF.preload('/Model/diamond12.glb')
