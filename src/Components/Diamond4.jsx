...
export function Diamond4(props) {
  const model = useRef()
  const [id, setId] = useState()
  const { nodes, materials } = useGLTF('/Model/diamond4.glb')
  ...
  return (
    ...
    <CubeCamera resolution={256} frames={1} envMap={texture}>
      {(texture) => (
        ...
        <instancedMesh ref={model} args={[nodes.Plane005.geometry, null, diamonds.length]}>
...
useGLTF.preload('/Model/diamond4.glb')
