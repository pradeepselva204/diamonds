...
export function Diamond9(props) {
  const model = useRef()
  const [id,setId] = useState()
  const { nodes, materials } = useGLTF('/Model/diamond9.glb')
  ...
  useFrame((state, delta) => {
    ...
    diamonds.forEach((data, i) => {
        ...
        dummy.rotation.set(0 , rotation[1], 1)
  ...
  return (
    ...
    <CubeCamera resolution={256} frames={1} envMap={texture}>
      {(texture) => (
        ...
        <instancedMesh ref={model} args={[nodes.Plane016.geometry, null, diamonds.length]}>
...
useGLTF.preload('/Model/diamond9.glb')
